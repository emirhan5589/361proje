// character_renderer_p2.v
module character_renderer_p2 (
    ...
    // Hitbox (attack box) bounds: 8×32, placed directly to the LEFT of the body for P2
    localparam HITBOX_WIDTH  = 32;
    localparam HITBOX_HEIGHT = 8;
    wire [9:0] hitbox_right  = char_x_pos_in - 1;  // To the left of body for P2
    wire [9:0] hitbox_left   = hitbox_right - HITBOX_WIDTH + 1;
    ...
    always @(*) begin
        ...
        // Draw hitbox during attack phases (to the left for P2)
